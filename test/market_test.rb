...
class MarketTest < Minitest::Test
  ...
  def test_it_can_find_vendors_that_sell_items
    market = Market.new("South Pearl Street Farmers Market")
    vendor1 = Vendor.new("Rocky Mountain Fresh")
  ...
  def test_it_can_get_total_inventory
    ...
    assert_equal expected, market.total_inventory.keys


  end

  def test_it_can_calculate_overstock
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_can_create_sorted_item_list
    market = Market.new("South Pearl Street Farmers Market")
  ...
  def test_it_is_sold
    ...
    assert_equal false, market.sold_out?(item1)
    vendor3.sell(item1, 65)
    vendor1.sell(item1, 35)
    assert_equal true, market.sold_out?(item1)
